...
in
{
  options.features.noctalia = {
    enable = mkOption {
      type = bool;
      default = featureCall.niri.noctalia.enabled || featureCall.umbriel.enabled; # Shoudl subclass this, creates inflexibility --- since might use other Desktop shell later;
