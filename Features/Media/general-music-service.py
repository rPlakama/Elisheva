#!/usr/bin/env python3
"""Elisheva FLAC→Opus Transcoder — parallel transcoding and stale FLAC cleanup.

All other library tasks (covers, lyrics, metadata, structuring) are handled
by beets.  This script only does what beets can't: in-place FLAC→Opus
transcoding with parallel workers, followed by cleanup of FLACs that have
a valid Opus sibling.
"""
